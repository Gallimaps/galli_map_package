...
class GalliUrl {
  ...
  String reverseGeoCode(LatLng latLng, String accessToken) =>
      "/reverseGeoApi/reverse/generalReverse?accessToken=$accessToken&lat=${latLng.latitude}&lng=${latLng.longitude}";
  String autoComplete(String query, String accessToken, {LatLng? latlng}) =>
      "/searchApi/geojson_getAll/search?accessToken=$accessToken&word=$query&lat=${latlng == null ? "" : latlng.latitude}&lng=${latlng == null ? "" : latlng.longitude}";
  String search(String place, LatLng latlng, String accessToken) =>
      "/searchApi/geojson/currentLocation?accessToken=$accessToken&name=$place&currentLat=${latlng.latitude}&currentLng=${latlng.longitude}";
